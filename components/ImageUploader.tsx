            ...
            >
              ...
              {image.status === 'pending' && (
                <button
                  ...
                  className="absolute top-1 right-1 bg-background/70 hover:bg-background rounded-full p-1"
                >
                  <svg className="w-3 h-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="space-y-2">
          ...
          {pendingCount > 0 && (
            <button
              ...
              className="w-full py-2.5 px-4 bg-primary text-primary-foreground rounded-lg text-sm font-medium disabled:opacity-50"
            >
